...
public class BabyDragon extends Troop {
    ...
    public void createImage() {
        ...
        this.setImage(image);
        //Move & Attack images
        this.setFirstMove(new Image(getClass().getResourceAsStream("/photos/BabyDragonMove/player/babyDragonMove1.png")));
        this.setSecondMove(new Image(getClass().getResourceAsStream("/photos/BabyDragonMove/player/babyDragonMove2.png")));
        this.setFirstAttack(new Image(getClass().getResourceAsStream("/photos/BabyDragonMove/player/babyDragonAttack1.png")));
        this.setSecondAttack(new Image(getClass().getResourceAsStream("/photos/BabyDragonMove/player/babyDragonAttack1.png")));
        this.setRobAttack1(new Image(getClass().getResourceAsStream("/photos/BabyDragonMove/robot/babyDragonAttack1.png")));
        this.setRobAttack2(new Image(getClass().getResourceAsStream("/photos/BabyDragonMove/robot/babyDragonAttack2.png")));
        this.setRobMove1(new Image(getClass().getResourceAsStream("/photos/BabyDragonMove/robot/babyDragonMove1.png")));
        this.setRobMove2(new Image(getClass().getResourceAsStream("/photos/BabyDragonMove/robot/babyDragonMove2.png")));
    }
