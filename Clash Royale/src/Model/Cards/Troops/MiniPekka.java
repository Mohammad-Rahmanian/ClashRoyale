...
public class MiniPekka extends Troop {
    ...
    public MiniPekka() {
        super(600, 325, 1.8, Speed.FAST,
                Target.GROUND, "Melee", false, 1, 4, "MiniPekka");
        createImage();
    }
    ...
    public void createImage() {
        Image image = new Image(getClass().getResourceAsStream("/photos/pekka.jpg"));
        this.setImage(image);
        //Move & Attack images
        this.setFirstAttack(new Image(getClass().getResourceAsStream("/photos/miniPekkaMove/player/minniPekkaAttack1.png")));
        this.setSecondAttack(new Image(getClass().getResourceAsStream("/photos/miniPekkaMove/player/minniPekkaAttack2.png")));
        this.setFirstMove(new Image(getClass().getResourceAsStream("/photos/miniPekkaMove/player/minniPekkaMove1.png")));
        this.setSecondMove(new Image(getClass().getResourceAsStream("/photos/miniPekkaMove/player/minniPekkaMove2.png")));
        this.setRobAttack1(new Image(getClass().getResourceAsStream("/photos/miniPekkaMove/robot/miniPekkaAttack1.png")));
        this.setRobAttack2(new Image(getClass().getResourceAsStream("/photos/miniPekkaMove/robot/miniPekkaAttack2.png")));
        this.setRobMove1(new Image(getClass().getResourceAsStream("/photos/miniPekkaMove/robot/miniPekkaMove1.png")));
        this.setRobMove2(new Image(getClass().getResourceAsStream("/photos/miniPekkaMove/robot/miniPekkaMove2.png")));
    }
